...
const SystemMonitorPage: React.FC = () => {
  ...
  const [stats, setStats] = useState<SystemLoad | null>(null);
        ...
        <div className="px-4 py-6 pb-32">
          <div className="mb-6">
            <div className="flex gap-2 mb-4">
              <Link
                to="/admin"
                className="btn-secondary-mobile flex-1 text-center"
              >
                ← {t("backToAdminPanel")}
              </Link>
              <Link
                to="/dashboard"
                className="btn-primary-mobile flex-1 text-center"
              >
                🏠 {t("backToMainMenu")}
              </Link>
            </div>
            <h1 className="text-2xl font-bold tg-text mb-2">
              ⚙️ {t("systemMonitoring")}
            </h1>
            ...
            <div className="card-mobile">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${Math.min((stats?.errorRate || 0) * 20, 100)}%`,
                  }}
                ></div>
              </div>
            </div>
          ...
          {/* Общая статистика */}
          <div className="card-mobile">
            <h3 className="text-lg font-semibold tg-text mb-4">
              📈 Статистика
            </h3>
